    ...
    en: [
        {
            ...
            paragraphs: [
                ...
                'Business address: Calle de Alcalá 54, 4º izquierda, 28014 Madrid, Madrid, Spain.',
        ...
        },
        {
            ...
            paragraphs: [
                'You may stop using Dropsauce at any time. Account deletion is available from Privacy & Security settings, through the account deletion page, or by contacting hello@dropsauce.app.',
    ...
    es: [
        {
            ...
            paragraphs: [
                ...
                'Domicilio profesional: Calle de Alcalá 54, 4º izquierda, 28014 Madrid, Madrid, Spain.',
        ...
        },
        {
            ...
            paragraphs: [
                'Puedes dejar de usar Dropsauce en cualquier momento. La eliminación de la cuenta está disponible desde Privacidad y seguridad, a través de la página de eliminación de cuenta o contactando con hello@dropsauce.app.',
